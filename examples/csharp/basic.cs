/*
 * Moon Position API - Basic Usage Example
 *
 * This example demonstrates the basic usage of the Moon Position API.
 * API Documentation: https://docs.apiverve.com/ref/moonposition
 */
...
{
    class MoonPositionExample
    {
        private static readonly string API_KEY = Environment.GetEnvironmentVariable("APIVERVE_API_KEY") ?? "YOUR_API_KEY_HERE";
        private static readonly string API_URL = "https://api.apiverve.com/v1/moonposition";

        /// <summary>
        /// Make a GET request to the Moon Position API
        /// </summary>
        static async Task<JsonDocument> CallMoonPositionAPI()
        {
            try
            {
        ...
        {
            Console.WriteLine("📤 Calling Moon Position API...\n");

            var result = await CallMoonPositionAPI();
