...
// Request contains the parameters for the Moon Position API.
//
// Parameters:
...
// ResponseData contains the data returned by the Moon Position API.
...
// MoonData represents the moon object.
