...
setup(
    ...
    project_urls={
        ...
        'Documentation': 'https://docs.apiverve.com/ref/moonposition',
        'Source': 'https://github.com/apiverve/moonposition-api',
        'Bug Tracker': 'https://github.com/apiverve/moonposition-api/issues'
    },
    classifiers=[
