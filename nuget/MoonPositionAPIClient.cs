...
namespace APIVerve.API.MoonPosition
{
    ...
    /// <summary>
    /// Client for the MoonPosition API
    /// </summary>
...
#endif
    {
        ...
        public MoonPositionAPIClient(string apiKey)
#if !NET20 && !NET35 && !NET40
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public MoonPositionAPIClient(string apiKey, bool isSecure, bool isDebug)
#if !NET20 && !NET35 && !NET40
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public MoonPositionAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        private void ValidateParams(MoonPositionQueryOptions options)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(MoonPositionQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(MoonPositionQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(MoonPositionQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(MoonPositionQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(MoonPositionQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
