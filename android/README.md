...
```gradle
dependencies {
    implementation 'com.github.apiverve:moonposition-api:1.1.12'
}
```
...
```java
import com.apiverve.moonposition.MoonPositionAPIClient;
import com.apiverve.moonposition.APIResponse;
import com.apiverve.moonposition.APIException;

// Initialize the client
MoonPositionAPIClient client = new MoonPositionAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/moonposition](https://docs.apiverve.com/ref/moonposition)
...
- **Documentation:** [https://docs.apiverve.com/ref/moonposition](https://docs.apiverve.com/ref/moonposition)
- **Issues:** [GitHub Issues](https://github.com/apiverve/moonposition-api/issues)
